...
export interface VerifyVoteExtensionRequest {
  ...
  non_rp_vote_extension: Uint8Array;
}
...
export interface ExtendedVoteInfo {
  ...
  non_rp_extension_signature: Uint8Array;
}
...
function createBaseVerifyVoteExtensionRequest(): VerifyVoteExtensionRequest {
  return {
    ...
    non_rp_vote_extension: new Uint8Array(0),
  };
}
...
export const VerifyVoteExtensionRequest = {
  ...
  encode(message: VerifyVoteExtensionRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.non_rp_vote_extension.length !== 0) {
      writer.uint32(42).bytes(message.non_rp_vote_extension);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.non_rp_vote_extension = reader.bytes();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): VerifyVoteExtensionRequest {
    return {
      ...
      non_rp_vote_extension: isSet(object.non_rp_vote_extension)
  ...
  toJSON(message: VerifyVoteExtensionRequest): unknown {
    ...
    if (message.non_rp_vote_extension !== undefined) {
      obj.non_rp_vote_extension = base64FromBytes(message.non_rp_vote_extension);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<VerifyVoteExtensionRequest>): VerifyVoteExtensionRequest {
    ...
    message.non_rp_vote_extension = object.non_rp_vote_extension ?? new Uint8Array(0);
    return message;
  },
};
...
function createBaseExtendVoteResponse(): ExtendVoteResponse {
  return { vote_extension: new Uint8Array(0), non_rp_extension: new Uint8Array(0) };
}
...
export const ExtendVoteResponse = {
  ...
  encode(message: ExtendVoteResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.non_rp_extension.length !== 0) {
      writer.uint32(18).bytes(message.non_rp_extension);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.non_rp_extension = reader.bytes();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ExtendVoteResponse {
    return {
      vote_extension: isSet(object.vote_extension) ? bytesFromBase64(object.vote_extension) : new Uint8Array(0),
      non_rp_extension: isSet(object.non_rp_extension) ? bytesFromBase64(object.non_rp_extension) : new Uint8Array(0),
    };
  },
  ...
  toJSON(message: ExtendVoteResponse): unknown {
    ...
    if (message.non_rp_extension !== undefined) {
      obj.non_rp_extension = base64FromBytes(message.non_rp_extension);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ExtendVoteResponse>): ExtendVoteResponse {
    const message = createBaseExtendVoteResponse();
    message.vote_extension = object.vote_extension ?? new Uint8Array(0);
    message.non_rp_extension = object.non_rp_extension ?? new Uint8Array(0);
    return message;
  },
};
...
function createBaseExtendedVoteInfo(): ExtendedVoteInfo {
  return {
    ...
    block_id_flag: 0,
    non_rp_vote_extension: new Uint8Array(0),
    non_rp_extension_signature: new Uint8Array(0),
  };
}
...
export const ExtendedVoteInfo = {
  ...
  encode(message: ExtendedVoteInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.non_rp_vote_extension.length !== 0) {
      writer.uint32(50).bytes(message.non_rp_vote_extension);
    }
    if (message.non_rp_extension_signature.length !== 0) {
      writer.uint32(58).bytes(message.non_rp_extension_signature);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.non_rp_extension_signature = reader.bytes();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ExtendedVoteInfo {
    return {
      ...
      non_rp_vote_extension: isSet(object.non_rp_vote_extension)
        ? bytesFromBase64(object.non_rp_vote_extension)
        : new Uint8Array(0),
      non_rp_extension_signature: isSet(object.non_rp_extension_signature)
  ...
  toJSON(message: ExtendedVoteInfo): unknown {
    ...
    if (message.non_rp_extension_signature !== undefined) {
      obj.non_rp_extension_signature = base64FromBytes(message.non_rp_extension_signature);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ExtendedVoteInfo>): ExtendedVoteInfo {
    ...
    message.block_id_flag = object.block_id_flag ?? 0;
    message.non_rp_vote_extension = object.non_rp_vote_extension ?? new Uint8Array(0);
    message.non_rp_extension_signature = object.non_rp_extension_signature ?? new Uint8Array(0);
    return message;
  },
};
