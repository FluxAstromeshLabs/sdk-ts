...
export const CanonicalBlockID = {
  $type: "cometbft.types.v1beta1.CanonicalBlockID" as const,
...
export const CanonicalPartSetHeader = {
  $type: "cometbft.types.v1beta1.CanonicalPartSetHeader" as const,
...
export const CanonicalProposal = {
  $type: "cometbft.types.v1beta1.CanonicalProposal" as const,
...
export const CanonicalVote = {
  $type: "cometbft.types.v1beta1.CanonicalVote" as const,
