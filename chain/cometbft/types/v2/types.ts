...
function createBaseVote(): Vote {
  return {
    ...
    non_rp_extension: new Uint8Array(0),
...
export const Vote = {
  ...
  encode(message: Vote, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.non_rp_extension.length !== 0) {
      writer.uint32(90).bytes(message.non_rp_extension);
    }
    if (message.non_rp_extension_signature.length !== 0) {
      writer.uint32(98).bytes(message.non_rp_extension_signature);
    }
    return writer;
  },
...
export const ExtendedCommitSig = {
  ...
  encode(message: ExtendedCommitSig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.non_rp_extension.length !== 0) {
      writer.uint32(58).bytes(message.non_rp_extension);
    }
    if (message.non_rp_extension_signature.length !== 0) {
      writer.uint32(66).bytes(message.non_rp_extension_signature);
    }
    return writer;
  },
