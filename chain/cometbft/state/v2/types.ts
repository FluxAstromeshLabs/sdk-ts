...
export const LegacyABCIResponses = {
  $type: "cometbft.state.v2.LegacyABCIResponses" as const,
...
export const ResponseBeginBlock = {
  $type: "cometbft.state.v2.ResponseBeginBlock" as const,
...
export const ResponseEndBlock = {
  $type: "cometbft.state.v2.ResponseEndBlock" as const,
...
export const ValidatorsInfo = {
  $type: "cometbft.state.v2.ValidatorsInfo" as const,
...
export const ConsensusParamsInfo = {
  $type: "cometbft.state.v2.ConsensusParamsInfo" as const,
...
export const ABCIResponsesInfo = {
  $type: "cometbft.state.v2.ABCIResponsesInfo" as const,
  ...
  encode(message: ABCIResponsesInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.finalize_block !== undefined) {
      FinalizeBlockResponse.encode(message.finalize_block, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
...
export const Version = {
  $type: "cometbft.state.v2.Version" as const,
...
export const State = {
  $type: "cometbft.state.v2.State" as const,
  ...
  encode(message: State, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.next_block_delay !== undefined) {
      Duration.encode(message.next_block_delay, writer.uint32(122).fork()).ldelim();
    }
    return writer;
  },
