...
export const MsgInfo = {
  $type: "cometbft.consensus.v1.MsgInfo" as const,
  ...
  encode(message: MsgInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.receive_time !== undefined) {
      Timestamp.encode(toTimestamp(message.receive_time), writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.receive_time = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  toJSON(message: MsgInfo): unknown {
    ...
    if (message.receive_time !== undefined) {
      obj.receive_time = message.receive_time.toISOString();
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<MsgInfo>): MsgInfo {
    ...
    message.receive_time = object.receive_time ?? undefined;
    return message;
  },
};
...
export const TimeoutInfo = {
  $type: "cometbft.consensus.v1.TimeoutInfo" as const,
...
export const EndHeight = {
  $type: "cometbft.consensus.v1.EndHeight" as const,
...
export const WALMessage = {
  $type: "cometbft.consensus.v1.WALMessage" as const,
...
export const TimedWALMessage = {
  $type: "cometbft.consensus.v1.TimedWALMessage" as const,
