...
export const NewRoundStep = {
  $type: "cometbft.consensus.v2.NewRoundStep" as const,
  ...
  toJSON(message: NewRoundStep): unknown {
    ...
    if (message.seconds_since_start_time !== undefined) {
      obj.seconds_since_start_time = message.seconds_since_start_time;
    }
    if (message.last_commit_round !== undefined) {
...
export const NewValidBlock = {
  $type: "cometbft.consensus.v2.NewValidBlock" as const,
  ...
  toJSON(message: NewValidBlock): unknown {
    ...
    if (message.is_commit !== undefined) {
...
export const Proposal = {
  $type: "cometbft.consensus.v2.Proposal" as const,
...
export const ProposalPOL = {
  $type: "cometbft.consensus.v2.ProposalPOL" as const,
  ...
  toJSON(message: ProposalPOL): unknown {
    ...
    if (message.proposal_pol_round !== undefined) {
...
export const BlockPart = {
  $type: "cometbft.consensus.v2.BlockPart" as const,
...
export const Vote = {
  $type: "cometbft.consensus.v2.Vote" as const,
...
export const HasVote = {
  $type: "cometbft.consensus.v2.HasVote" as const,
...
export const VoteSetMaj23 = {
  $type: "cometbft.consensus.v2.VoteSetMaj23" as const,
...
export const VoteSetBits = {
  $type: "cometbft.consensus.v2.VoteSetBits" as const,
...
export const HasProposalBlockPart = {
  $type: "cometbft.consensus.v2.HasProposalBlockPart" as const,

  encode(message: HasProposalBlockPart, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.height !== "0") {
      writer.uint32(8).int64(message.height);
    }
    if (message.round !== 0) {
...
export const Message = {
  $type: "cometbft.consensus.v2.Message" as const,
  ...
  encode(message: Message, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.has_proposal_block_part !== undefined) {
      HasProposalBlockPart.encode(message.has_proposal_block_part, writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },
