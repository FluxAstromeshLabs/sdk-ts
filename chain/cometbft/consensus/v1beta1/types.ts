...
export const NewRoundStep = {
  $type: "cometbft.consensus.v1beta1.NewRoundStep" as const,
...
export const NewValidBlock = {
  $type: "cometbft.consensus.v1beta1.NewValidBlock" as const,
...
export const Proposal = {
  $type: "cometbft.consensus.v1beta1.Proposal" as const,
...
export const ProposalPOL = {
  $type: "cometbft.consensus.v1beta1.ProposalPOL" as const,
...
export const BlockPart = {
  $type: "cometbft.consensus.v1beta1.BlockPart" as const,
...
export const Vote = {
  $type: "cometbft.consensus.v1beta1.Vote" as const,
...
export const HasVote = {
  $type: "cometbft.consensus.v1beta1.HasVote" as const,
...
export const VoteSetMaj23 = {
  $type: "cometbft.consensus.v1beta1.VoteSetMaj23" as const,
...
export const VoteSetBits = {
  $type: "cometbft.consensus.v1beta1.VoteSetBits" as const,
...
export const Message = {
  $type: "cometbft.consensus.v1beta1.Message" as const,
