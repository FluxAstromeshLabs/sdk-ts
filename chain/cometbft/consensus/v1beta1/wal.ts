...
export const MsgInfo = {
  $type: "cometbft.consensus.v1beta1.MsgInfo" as const,
...
export const TimeoutInfo = {
  $type: "cometbft.consensus.v1beta1.TimeoutInfo" as const,
...
export const EndHeight = {
  $type: "cometbft.consensus.v1beta1.EndHeight" as const,
...
export const WALMessage = {
  $type: "cometbft.consensus.v1beta1.WALMessage" as const,
...
export const TimedWALMessage = {
  $type: "cometbft.consensus.v1beta1.TimedWALMessage" as const,
