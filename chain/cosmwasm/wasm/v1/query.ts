...
export const QueryContractInfoRequest: MessageFns<
...
export const QueryContractInfoResponse: MessageFns<
...
> = {
  ...
  encode(message: QueryContractInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.contract_info !== undefined) {
      ContractInfo.encode(message.contract_info, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const QueryContractHistoryRequest: MessageFns<
...
export const QueryContractHistoryResponse: MessageFns<
...
export const QueryContractsByCodeRequest: MessageFns<
...
export const QueryContractsByCodeResponse: MessageFns<
...
export const QueryAllContractStateRequest: MessageFns<
...
export const QueryAllContractStateResponse: MessageFns<
...
export const QueryRawContractStateRequest: MessageFns<
...
export const QueryRawContractStateResponse: MessageFns<
...
export const QuerySmartContractStateRequest: MessageFns<
...
export const QuerySmartContractStateResponse: MessageFns<
...
export const QueryCodeRequest: MessageFns<QueryCodeRequest, "cosmwasm.wasm.v1.QueryCodeRequest"> = {
...
export const QueryCodeInfoRequest: MessageFns<QueryCodeInfoRequest, "cosmwasm.wasm.v1.QueryCodeInfoRequest"> = {
...
export const QueryCodeInfoResponse: MessageFns<QueryCodeInfoResponse, "cosmwasm.wasm.v1.QueryCodeInfoResponse"> = {
...
export const CodeInfoResponse: MessageFns<CodeInfoResponse, "cosmwasm.wasm.v1.CodeInfoResponse"> = {
  ...
  encode(message: CodeInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.instantiate_permission !== undefined) {
      AccessConfig.encode(message.instantiate_permission, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
export const QueryCodeResponse: MessageFns<QueryCodeResponse, "cosmwasm.wasm.v1.QueryCodeResponse"> = {
  ...
  encode(message: QueryCodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code_info !== undefined) {
      CodeInfoResponse.encode(message.code_info, writer.uint32(10).fork()).join();
    }
    if (message.data.length !== 0) {
...
export const QueryCodesRequest: MessageFns<QueryCodesRequest, "cosmwasm.wasm.v1.QueryCodesRequest"> = {
...
export const QueryCodesResponse: MessageFns<QueryCodesResponse, "cosmwasm.wasm.v1.QueryCodesResponse"> = {
...
export const QueryPinnedCodesRequest: MessageFns<QueryPinnedCodesRequest, "cosmwasm.wasm.v1.QueryPinnedCodesRequest"> =
  {
...
export const QueryPinnedCodesResponse: MessageFns<
...
export const QueryParamsRequest: MessageFns<QueryParamsRequest, "cosmwasm.wasm.v1.QueryParamsRequest"> = {
...
export const QueryParamsResponse: MessageFns<QueryParamsResponse, "cosmwasm.wasm.v1.QueryParamsResponse"> = {
...
export const QueryContractsByCreatorRequest: MessageFns<
...
export const QueryContractsByCreatorResponse: MessageFns<
...
export const QueryBuildAddressRequest: MessageFns<
...
export const QueryBuildAddressResponse: MessageFns<
