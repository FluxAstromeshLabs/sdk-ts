...
export const MsgStoreCode: MessageFns<MsgStoreCode, "cosmwasm.wasm.v1.MsgStoreCode"> = {
  ...
  encode(message: MsgStoreCode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.instantiate_permission !== undefined) {
      AccessConfig.encode(message.instantiate_permission, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export const MsgStoreCodeResponse: MessageFns<MsgStoreCodeResponse, "cosmwasm.wasm.v1.MsgStoreCodeResponse"> = {
...
export const MsgInstantiateContract: MessageFns<MsgInstantiateContract, "cosmwasm.wasm.v1.MsgInstantiateContract"> = {
...
export const MsgInstantiateContractResponse: MessageFns<
...
export const MsgInstantiateContract2: MessageFns<MsgInstantiateContract2, "cosmwasm.wasm.v1.MsgInstantiateContract2"> =
  {
...
export const MsgInstantiateContract2Response: MessageFns<
...
export const MsgExecuteContract: MessageFns<MsgExecuteContract, "cosmwasm.wasm.v1.MsgExecuteContract"> = {
...
export const MsgExecuteContractResponse: MessageFns<
...
export const MsgMigrateContract: MessageFns<MsgMigrateContract, "cosmwasm.wasm.v1.MsgMigrateContract"> = {
...
export const MsgUpdateAdmin: MessageFns<MsgUpdateAdmin, "cosmwasm.wasm.v1.MsgUpdateAdmin"> = {
...
export const MsgUpdateAdminResponse: MessageFns<MsgUpdateAdminResponse, "cosmwasm.wasm.v1.MsgUpdateAdminResponse"> = {
...
export const MsgClearAdmin: MessageFns<MsgClearAdmin, "cosmwasm.wasm.v1.MsgClearAdmin"> = {
...
export const MsgClearAdminResponse: MessageFns<MsgClearAdminResponse, "cosmwasm.wasm.v1.MsgClearAdminResponse"> = {
...
export const MsgUpdateInstantiateConfig: MessageFns<
...
> = {
  ...
  encode(message: MsgUpdateInstantiateConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.new_instantiate_permission !== undefined) {
      AccessConfig.encode(message.new_instantiate_permission, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const MsgUpdateInstantiateConfigResponse: MessageFns<
...
export const MsgUpdateParams: MessageFns<MsgUpdateParams, "cosmwasm.wasm.v1.MsgUpdateParams"> = {
...
export const MsgUpdateParamsResponse: MessageFns<MsgUpdateParamsResponse, "cosmwasm.wasm.v1.MsgUpdateParamsResponse"> =
  {
...
export const MsgSudoContract: MessageFns<MsgSudoContract, "cosmwasm.wasm.v1.MsgSudoContract"> = {
...
export const MsgSudoContractResponse: MessageFns<MsgSudoContractResponse, "cosmwasm.wasm.v1.MsgSudoContractResponse"> =
  {
...
export const MsgPinCodes: MessageFns<MsgPinCodes, "cosmwasm.wasm.v1.MsgPinCodes"> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgPinCodes {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          if (tag === 16) {
            message.code_ids.push(reader.uint64().toString());
...
export const MsgPinCodesResponse: MessageFns<MsgPinCodesResponse, "cosmwasm.wasm.v1.MsgPinCodesResponse"> = {
...
export const MsgUnpinCodes: MessageFns<MsgUnpinCodes, "cosmwasm.wasm.v1.MsgUnpinCodes"> = {
...
export const MsgUnpinCodesResponse: MessageFns<MsgUnpinCodesResponse, "cosmwasm.wasm.v1.MsgUnpinCodesResponse"> = {
...
export const MsgStoreAndInstantiateContract: MessageFns<
...
> = {
  ...
  encode(message: MsgStoreAndInstantiateContract, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.instantiate_permission !== undefined) {
      AccessConfig.encode(message.instantiate_permission, writer.uint32(34).fork()).join();
    }
...
export const MsgStoreAndInstantiateContractResponse: MessageFns<
...
export const MsgAddCodeUploadParamsAddresses: MessageFns<
...
export const MsgAddCodeUploadParamsAddressesResponse: MessageFns<
...
export const MsgRemoveCodeUploadParamsAddresses: MessageFns<
...
export const MsgRemoveCodeUploadParamsAddressesResponse: MessageFns<
...
export const MsgStoreAndMigrateContract: MessageFns<
...
> = {
  ...
  encode(message: MsgStoreAndMigrateContract, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.instantiate_permission !== undefined) {
      AccessConfig.encode(message.instantiate_permission, writer.uint32(26).fork()).join();
    }
    if (message.contract !== "") {
...
export const MsgStoreAndMigrateContractResponse: MessageFns<
...
export const MsgUpdateContractLabel: MessageFns<MsgUpdateContractLabel, "cosmwasm.wasm.v1.MsgUpdateContractLabel"> = {
...
export const MsgUpdateContractLabelResponse: MessageFns<
