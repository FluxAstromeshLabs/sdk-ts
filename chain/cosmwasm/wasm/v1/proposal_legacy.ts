...
export const StoreCodeProposal: MessageFns<StoreCodeProposal, "cosmwasm.wasm.v1.StoreCodeProposal"> = {
  ...
  encode(message: StoreCodeProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.instantiate_permission !== undefined) {
      AccessConfig.encode(message.instantiate_permission, writer.uint32(58).fork()).join();
    }
...
export const InstantiateContractProposal: MessageFns<
...
export const InstantiateContract2Proposal: MessageFns<
...
export const MigrateContractProposal: MessageFns<MigrateContractProposal, "cosmwasm.wasm.v1.MigrateContractProposal"> =
  {
...
export const SudoContractProposal: MessageFns<SudoContractProposal, "cosmwasm.wasm.v1.SudoContractProposal"> = {
...
export const ExecuteContractProposal: MessageFns<ExecuteContractProposal, "cosmwasm.wasm.v1.ExecuteContractProposal"> =
  {
...
export const UpdateAdminProposal: MessageFns<UpdateAdminProposal, "cosmwasm.wasm.v1.UpdateAdminProposal"> = {
...
export const ClearAdminProposal: MessageFns<ClearAdminProposal, "cosmwasm.wasm.v1.ClearAdminProposal"> = {
...
export const PinCodesProposal: MessageFns<PinCodesProposal, "cosmwasm.wasm.v1.PinCodesProposal"> = {
...
export const UnpinCodesProposal: MessageFns<UnpinCodesProposal, "cosmwasm.wasm.v1.UnpinCodesProposal"> = {
...
export const AccessConfigUpdate: MessageFns<AccessConfigUpdate, "cosmwasm.wasm.v1.AccessConfigUpdate"> = {
  ...
  encode(message: AccessConfigUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.instantiate_permission !== undefined) {
      AccessConfig.encode(message.instantiate_permission, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const UpdateInstantiateConfigProposal: MessageFns<
...
export const StoreAndInstantiateContractProposal: MessageFns<
