...
export const GenesisState: MessageFns<GenesisState, "cosmwasm.wasm.v1.GenesisState"> = {
...
export const Code: MessageFns<Code, "cosmwasm.wasm.v1.Code"> = {
  ...
  encode(message: Code, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.code_info !== undefined) {
      CodeInfo.encode(message.code_info, writer.uint32(18).fork()).join();
    }
...
export const Contract: MessageFns<Contract, "cosmwasm.wasm.v1.Contract"> = {
...
export const Sequence: MessageFns<Sequence, "cosmwasm.wasm.v1.Sequence"> = {
