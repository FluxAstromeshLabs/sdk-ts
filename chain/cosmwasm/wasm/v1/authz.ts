...
export const StoreCodeAuthorization: MessageFns<StoreCodeAuthorization, "cosmwasm.wasm.v1.StoreCodeAuthorization"> = {
...
export const ContractExecutionAuthorization: MessageFns<
...
export const ContractMigrationAuthorization: MessageFns<
...
export const CodeGrant: MessageFns<CodeGrant, "cosmwasm.wasm.v1.CodeGrant"> = {
...
export const ContractGrant: MessageFns<ContractGrant, "cosmwasm.wasm.v1.ContractGrant"> = {
...
export const MaxCallsLimit: MessageFns<MaxCallsLimit, "cosmwasm.wasm.v1.MaxCallsLimit"> = {
...
export const MaxFundsLimit: MessageFns<MaxFundsLimit, "cosmwasm.wasm.v1.MaxFundsLimit"> = {
...
export const CombinedLimit: MessageFns<CombinedLimit, "cosmwasm.wasm.v1.CombinedLimit"> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.calls_remaining = reader.uint64().toString();
          continue;
        case 2:
          if (tag !== 18) {
            break;
...
export const AllowAllMessagesFilter: MessageFns<AllowAllMessagesFilter, "cosmwasm.wasm.v1.AllowAllMessagesFilter"> = {
...
export const AcceptedMessageKeysFilter: MessageFns<
...
export const AcceptedMessagesFilter: MessageFns<AcceptedMessagesFilter, "cosmwasm.wasm.v1.AcceptedMessagesFilter"> = {
