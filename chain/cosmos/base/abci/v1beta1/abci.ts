    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.gas_wanted = reader.uint64().toString();
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.gas_used = reader.uint64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.total_count = reader.uint64().toString();
          continue;
        case 2:
          if (tag !== 16) {
            break;
        ...
        case 3:
          ...
          message.page_number = reader.uint64().toString();
          continue;
        case 4:
          if (tag !== 32) {
            break;
          ...
          message.page_total = reader.uint64().toString();
          continue;
        case 5:
          if (tag !== 40) {
            break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.total_count = reader.int64().toString();
          continue;
        case 2:
          if (tag !== 16) {
            break;
        ...
        case 3:
          ...
          message.page_number = reader.int64().toString();
          continue;
        case 4:
          if (tag !== 32) {
            break;
          ...
          message.page_total = reader.int64().toString();
          continue;
        case 5:
          if (tag !== 40) {
            break;
