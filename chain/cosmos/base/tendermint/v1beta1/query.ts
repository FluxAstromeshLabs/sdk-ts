    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.block_height = reader.int64().toString();
          continue;
        case 2:
          if (tag !== 18) {
            break;
...
> = {
  ...
  encode(message: GetBlockByHeightResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.sdk_block !== undefined) {
      Block1.encode(message.sdk_block, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
> = {
  ...
  encode(message: GetNodeInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.default_node_info !== undefined) {
      DefaultNodeInfo.encode(message.default_node_info, writer.uint32(10).fork()).join();
    }
