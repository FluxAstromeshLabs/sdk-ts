    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.account_number = reader.uint64().toString();
          continue;
        case 4:
          if (tag !== 32) {
            break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.max_memo_characters = reader.uint64().toString();
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.tx_sig_limit = reader.uint64().toString();
          continue;
        case 3:
          if (tag !== 24) {
            break;
          ...
          message.tx_size_cost_per_byte = reader.uint64().toString();
          continue;
        case 4:
          if (tag !== 32) {
            break;
          ...
          message.sig_verify_cost_ed25519 = reader.uint64().toString();
          continue;
        case 5:
          if (tag !== 40) {
            break;
          ...
          message.sig_verify_cost_secp256k1 = reader.uint64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
