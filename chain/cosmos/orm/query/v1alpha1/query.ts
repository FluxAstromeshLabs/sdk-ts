...
export const GetRequest: MessageFns<GetRequest, "cosmos.orm.query.v1alpha1.GetRequest"> = {
...
export const GetResponse: MessageFns<GetResponse, "cosmos.orm.query.v1alpha1.GetResponse"> = {
...
export const ListRequest: MessageFns<ListRequest, "cosmos.orm.query.v1alpha1.ListRequest"> = {
...
export const ListRequest_Prefix: MessageFns<ListRequest_Prefix, "cosmos.orm.query.v1alpha1.ListRequest.Prefix"> = {
...
export const ListRequest_Range: MessageFns<ListRequest_Range, "cosmos.orm.query.v1alpha1.ListRequest.Range"> = {
...
export const ListResponse: MessageFns<ListResponse, "cosmos.orm.query.v1alpha1.ListResponse"> = {
...
export const IndexValue: MessageFns<IndexValue, "cosmos.orm.query.v1alpha1.IndexValue"> = {
