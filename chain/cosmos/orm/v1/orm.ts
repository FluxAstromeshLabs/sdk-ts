...
export const TableDescriptor: MessageFns<TableDescriptor, "cosmos.orm.v1.TableDescriptor"> = {
  ...
  encode(message: TableDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.primary_key !== undefined) {
      PrimaryKeyDescriptor.encode(message.primary_key, writer.uint32(10).fork()).join();
    }
...
export const PrimaryKeyDescriptor: MessageFns<PrimaryKeyDescriptor, "cosmos.orm.v1.PrimaryKeyDescriptor"> = {
...
export const SecondaryIndexDescriptor: MessageFns<SecondaryIndexDescriptor, "cosmos.orm.v1.SecondaryIndexDescriptor"> =
  {
...
export const SingletonDescriptor: MessageFns<SingletonDescriptor, "cosmos.orm.v1.SingletonDescriptor"> = {
