...
export const ModuleSchemaDescriptor: MessageFns<ModuleSchemaDescriptor, "cosmos.orm.v1alpha1.ModuleSchemaDescriptor"> =
  {
...
export const ModuleSchemaDescriptor_FileEntry: MessageFns<
