...
export const SignDocDirectAux: MessageFns<SignDocDirectAux, "cosmos.tx.v1beta1.SignDocDirectAux"> = {
  ...
  encode(message: SignDocDirectAux, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.public_key !== undefined) {
      Any.encode(message.public_key, writer.uint32(18).fork()).join();
    }
    if (message.chain_id !== "") {
      writer.uint32(26).string(message.chain_id);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.gas_limit = reader.uint64().toString();
          continue;
        case 3:
          if (tag !== 26) {
            break;
...
export const AuxSignerData: MessageFns<AuxSignerData, "cosmos.tx.v1beta1.AuxSignerData"> = {
  ...
  encode(message: AuxSignerData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.sign_doc !== undefined) {
      SignDocDirectAux.encode(message.sign_doc, writer.uint32(18).fork()).join();
    }
    if (message.mode !== 0) {
