...
export const Member: MessageFns<Member, "cosmos.group.v1.Member"> = {
  ...
  encode(message: Member, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.added_at !== undefined) {
      Timestamp.encode(toTimestamp(message.added_at), writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
export const DecisionPolicyWindows: MessageFns<DecisionPolicyWindows, "cosmos.group.v1.DecisionPolicyWindows"> = {
  ...
  encode(message: DecisionPolicyWindows, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.min_execution_period !== undefined) {
      Duration.encode(message.min_execution_period, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const GroupPolicyInfo: MessageFns<GroupPolicyInfo, "cosmos.group.v1.GroupPolicyInfo"> = {
  ...
  encode(message: GroupPolicyInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.decision_policy !== undefined) {
      Any.encode(message.decision_policy, writer.uint32(50).fork()).join();
    }
    if (message.created_at !== undefined) {
...
export const Proposal: MessageFns<Proposal, "cosmos.group.v1.Proposal"> = {
  ...
  encode(message: Proposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.final_tally_result !== undefined) {
      TallyResult.encode(message.final_tally_result, writer.uint32(74).fork()).join();
    }
    if (message.voting_period_end !== undefined) {
      Timestamp.encode(toTimestamp(message.voting_period_end), writer.uint32(82).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.group_version = reader.uint64().toString();
          continue;
        case 7:
          if (tag !== 56) {
            break;
          ...
          message.group_policy_version = reader.uint64().toString();
          continue;
        case 8:
          if (tag !== 64) {
            break;
