    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.start_height = reader.int64().toString();
          continue;
        case 3:
          if (tag !== 24) {
            break;
          ...
          message.index_offset = reader.int64().toString();
          continue;
        case 4:
          if (tag !== 34) {
            break;
        ...
        case 6:
          ...
          message.missed_blocks_counter = reader.int64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.signed_blocks_window = reader.int64().toString();
          continue;
        case 2:
          if (tag !== 18) {
            break;
