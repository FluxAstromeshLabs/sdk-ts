...
export const MsgChannelOpenTry: MessageFns<MsgChannelOpenTry, "ibc.core.channel.v1.MsgChannelOpenTry"> = {
  ...
  encode(message: MsgChannelOpenTry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.proof_height !== undefined) {
      Height.encode(message.proof_height, writer.uint32(50).fork()).join();
    }
    if (message.signer !== "") {
...
export const MsgChannelOpenConfirm: MessageFns<MsgChannelOpenConfirm, "ibc.core.channel.v1.MsgChannelOpenConfirm"> = {
  ...
  encode(message: MsgChannelOpenConfirm, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.proof_height !== undefined) {
      Height.encode(message.proof_height, writer.uint32(34).fork()).join();
    }
    if (message.signer !== "") {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 6:
            ...
            message.counterparty_upgrade_sequence = reader.uint64().toString();
            continue;
        }
        if ((tag & 7) === 4 || tag === 0) {
          break;
...
export const MsgRecvPacket: MessageFns<MsgRecvPacket, "ibc.core.channel.v1.MsgRecvPacket"> = {
  ...
  encode(message: MsgRecvPacket, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.proof_height !== undefined) {
      Height.encode(message.proof_height, writer.uint32(26).fork()).join();
    }
    if (message.signer !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.next_sequence_recv = reader.uint64().toString();
          continue;
        case 5:
          if (tag !== 42) {
            break;
...
export const MsgChannelUpgradeInit: MessageFns<MsgChannelUpgradeInit, "ibc.core.channel.v1.MsgChannelUpgradeInit"> = {
...
export const MsgChannelUpgradeInitResponse: MessageFns<
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.upgrade_sequence = reader.uint64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const MsgChannelUpgradeTry: MessageFns<MsgChannelUpgradeTry, "ibc.core.channel.v1.MsgChannelUpgradeTry"> = {
  ...
  encode(message: MsgChannelUpgradeTry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.counterparty_upgrade_fields !== undefined) {
      UpgradeFields.encode(message.counterparty_upgrade_fields, writer.uint32(34).fork()).join();
    }
    if (message.counterparty_upgrade_sequence !== "0") {
    ...
    if (message.proof_height !== undefined) {
      Height.encode(message.proof_height, writer.uint32(66).fork()).join();
    }
    if (message.signer !== "") {
...
export const MsgChannelUpgradeTryResponse: MessageFns<
...
export const MsgChannelUpgradeAck: MessageFns<MsgChannelUpgradeAck, "ibc.core.channel.v1.MsgChannelUpgradeAck"> = {
  ...
  encode(message: MsgChannelUpgradeAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.counterparty_upgrade !== undefined) {
      Upgrade.encode(message.counterparty_upgrade, writer.uint32(26).fork()).join();
    }
    if (message.proof_channel.length !== 0) {
...
export const MsgChannelUpgradeAckResponse: MessageFns<
...
export const MsgChannelUpgradeConfirm: MessageFns<
...
> = {
  ...
  encode(message: MsgChannelUpgradeConfirm, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.counterparty_upgrade !== undefined) {
      Upgrade.encode(message.counterparty_upgrade, writer.uint32(34).fork()).join();
    }
    if (message.proof_channel.length !== 0) {
    ...
    if (message.proof_height !== undefined) {
      Height.encode(message.proof_height, writer.uint32(58).fork()).join();
    }
    if (message.signer !== "") {
...
export const MsgChannelUpgradeConfirmResponse: MessageFns<
...
export const MsgChannelUpgradeOpen: MessageFns<MsgChannelUpgradeOpen, "ibc.core.channel.v1.MsgChannelUpgradeOpen"> = {
...
export const MsgChannelUpgradeOpenResponse: MessageFns<
...
export const MsgChannelUpgradeTimeout: MessageFns<
...
> = {
  ...
  encode(message: MsgChannelUpgradeTimeout, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.counterparty_channel !== undefined) {
      Channel.encode(message.counterparty_channel, writer.uint32(26).fork()).join();
    }
    if (message.proof_channel.length !== 0) {
      writer.uint32(34).bytes(message.proof_channel);
    }
    if (message.proof_height !== undefined) {
      Height.encode(message.proof_height, writer.uint32(42).fork()).join();
    }
    if (message.signer !== "") {
      writer.uint32(50).string(message.signer);
    }
...
export const MsgChannelUpgradeTimeoutResponse: MessageFns<
...
export const MsgChannelUpgradeCancel: MessageFns<
...
> = {
  ...
  encode(message: MsgChannelUpgradeCancel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.error_receipt !== undefined) {
      ErrorReceipt.encode(message.error_receipt, writer.uint32(26).fork()).join();
    }
...
export const MsgChannelUpgradeCancelResponse: MessageFns<
...
export const MsgUpdateParams: MessageFns<MsgUpdateParams, "ibc.core.channel.v1.MsgUpdateParams"> = {
...
export const MsgPruneAcknowledgements: MessageFns<
...
export const MsgPruneAcknowledgementsResponse: MessageFns<
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.total_pruned_sequences = reader.uint64().toString();
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.total_remaining_sequences = reader.uint64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
