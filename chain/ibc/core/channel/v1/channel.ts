...
export const Packet: MessageFns<Packet, "ibc.core.channel.v1.Packet"> = {
  ...
  encode(message: Packet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.timeout_height !== undefined) {
      Height.encode(message.timeout_height, writer.uint32(58).fork()).join();
    }
...
export const Params: MessageFns<Params, "ibc.core.channel.v1.Params"> = {
  $type: "ibc.core.channel.v1.Params" as const,

  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.upgrade_timeout !== undefined) {
      Timeout.encode(message.upgrade_timeout, writer.uint32(10).fork()).join();
    }
    return writer;
  },
