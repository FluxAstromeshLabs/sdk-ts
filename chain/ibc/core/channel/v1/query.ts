...
> = {
  ...
  encode(message: QueryChannelClientStateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identified_client_state !== undefined) {
      IdentifiedClientState.encode(message.identified_client_state, writer.uint32(10).fork()).join();
    }
    if (message.proof.length !== 0) {
      writer.uint32(18).bytes(message.proof);
    }
...
> = {
  ...
  encode(message: QueryChannelConsensusStateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.consensus_state !== undefined) {
      Any.encode(message.consensus_state, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPacketAcknowledgementsRequest {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          if (tag === 32) {
            message.packet_commitment_sequences.push(reader.uint64().toString());
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryUnreceivedAcksRequest {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          if (tag === 24) {
            message.packet_ack_sequences.push(reader.uint64().toString());
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.next_sequence_receive = reader.uint64().toString();
          continue;
        case 2:
          if (tag !== 18) {
            break;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.next_sequence_send = reader.uint64().toString();
          continue;
        case 2:
          if (tag !== 18) {
            break;
...
export const QueryUpgradeErrorRequest: MessageFns<
...
export const QueryUpgradeErrorResponse: MessageFns<
...
> = {
  ...
  encode(message: QueryUpgradeErrorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.error_receipt !== undefined) {
      ErrorReceipt.encode(message.error_receipt, writer.uint32(10).fork()).join();
    }
    if (message.proof.length !== 0) {
      writer.uint32(18).bytes(message.proof);
    }
...
export const QueryUpgradeRequest: MessageFns<QueryUpgradeRequest, "ibc.core.channel.v1.QueryUpgradeRequest"> = {
...
export const QueryUpgradeResponse: MessageFns<QueryUpgradeResponse, "ibc.core.channel.v1.QueryUpgradeResponse"> = {
...
export const QueryChannelParamsRequest: MessageFns<
...
export const QueryChannelParamsResponse: MessageFns<
