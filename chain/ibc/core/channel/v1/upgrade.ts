...
export const Upgrade: MessageFns<Upgrade, "ibc.core.channel.v1.Upgrade"> = {
...
export const UpgradeFields: MessageFns<UpgradeFields, "ibc.core.channel.v1.UpgradeFields"> = {
...
export const ErrorReceipt: MessageFns<ErrorReceipt, "ibc.core.channel.v1.ErrorReceipt"> = {
