...
export interface QueryVerifyMembershipRequest {
  ...
  merkle_path: MerklePath | undefined;
}
...
> = {
  ...
  encode(message: QueryClientStateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.client_state !== undefined) {
      Any.encode(message.client_state, writer.uint32(10).fork()).join();
    }
...
> = {
  ...
  encode(message: QueryUpgradedClientStateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.upgraded_client_state !== undefined) {
      Any.encode(message.upgraded_client_state, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
> = {
  ...
  encode(message: QueryUpgradedConsensusStateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.upgraded_consensus_state !== undefined) {
      Any.encode(message.upgraded_consensus_state, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
> = {
  ...
  encode(message: QueryVerifyMembershipRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.merkle_path !== undefined) {
      MerklePath.encode(message.merkle_path, writer.uint32(66).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.time_delay = reader.uint64().toString();
          continue;
        case 7:
          if (tag !== 56) {
            break;
          ...
          message.block_delay = reader.uint64().toString();
          continue;
        case 8:
          if (tag !== 66) {
            break;
