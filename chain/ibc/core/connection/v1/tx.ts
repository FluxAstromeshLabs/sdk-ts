      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 4:
            ...
            message.delay_period = reader.uint64().toString();
            continue;
          case 5:
            if (tag !== 42) {
              break;
...
export const MsgConnectionOpenTry: MessageFns<MsgConnectionOpenTry, "ibc.core.connection.v1.MsgConnectionOpenTry"> = {
  ...
  encode(message: MsgConnectionOpenTry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.client_state !== undefined) {
      Any.encode(message.client_state, writer.uint32(26).fork()).join();
    }
    if (message.counterparty !== undefined) {
    ...
    if (message.consensus_height !== undefined) {
      Height.encode(message.consensus_height, writer.uint32(90).fork()).join();
    }
    if (message.signer !== "") {
...
export const MsgConnectionOpenAck: MessageFns<MsgConnectionOpenAck, "ibc.core.connection.v1.MsgConnectionOpenAck"> = {
  ...
  encode(message: MsgConnectionOpenAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.client_state !== undefined) {
      Any.encode(message.client_state, writer.uint32(34).fork()).join();
    }
    if (message.proof_height !== undefined) {
    ...
    if (message.consensus_height !== undefined) {
      Height.encode(message.consensus_height, writer.uint32(74).fork()).join();
    }
    if (message.signer !== "") {
