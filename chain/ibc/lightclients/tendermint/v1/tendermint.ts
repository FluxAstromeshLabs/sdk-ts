...
export const ClientState: MessageFns<ClientState, "ibc.lightclients.tendermint.v1.ClientState"> = {
  ...
  encode(message: ClientState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.trust_level !== undefined) {
      Fraction.encode(message.trust_level, writer.uint32(18).fork()).join();
    }
    if (message.trusting_period !== undefined) {
      Duration.encode(message.trusting_period, writer.uint32(26).fork()).join();
    }
    if (message.unbonding_period !== undefined) {
      Duration.encode(message.unbonding_period, writer.uint32(34).fork()).join();
    }
    if (message.max_clock_drift !== undefined) {
      Duration.encode(message.max_clock_drift, writer.uint32(42).fork()).join();
    }
    if (message.frozen_height !== undefined) {
      Height.encode(message.frozen_height, writer.uint32(50).fork()).join();
    }
    if (message.latest_height !== undefined) {
      Height.encode(message.latest_height, writer.uint32(58).fork()).join();
    }
...
export const Misbehaviour: MessageFns<Misbehaviour, "ibc.lightclients.tendermint.v1.Misbehaviour"> = {
  ...
  encode(message: Misbehaviour, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.header_1 !== undefined) {
      Header.encode(message.header_1, writer.uint32(18).fork()).join();
    }
    if (message.header_2 !== undefined) {
      Header.encode(message.header_2, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const Header: MessageFns<Header, "ibc.lightclients.tendermint.v1.Header"> = {
  ...
  encode(message: Header, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.trusted_height !== undefined) {
      Height.encode(message.trusted_height, writer.uint32(26).fork()).join();
    }
    if (message.trusted_validators !== undefined) {
      ValidatorSet.encode(message.trusted_validators, writer.uint32(34).fork()).join();
    }
    return writer;
  },
