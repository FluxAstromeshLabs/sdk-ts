...
export const Header: MessageFns<Header, "ibc.lightclients.solomachine.v3.Header"> = {
  ...
  encode(message: Header, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.new_public_key !== undefined) {
      Any.encode(message.new_public_key, writer.uint32(26).fork()).join();
    }
...
export const Misbehaviour: MessageFns<Misbehaviour, "ibc.lightclients.solomachine.v3.Misbehaviour"> = {
  ...
  encode(message: Misbehaviour, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.signature_one !== undefined) {
      SignatureAndData.encode(message.signature_one, writer.uint32(18).fork()).join();
    }
    if (message.signature_two !== undefined) {
      SignatureAndData.encode(message.signature_two, writer.uint32(26).fork()).join();
    }
    return writer;
  },
