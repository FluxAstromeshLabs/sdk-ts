...
export const ClientState: MessageFns<ClientState, "ibc.lightclients.solomachine.v2.ClientState"> = {
  ...
  encode(message: ClientState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.consensus_state !== undefined) {
      ConsensusState.encode(message.consensus_state, writer.uint32(26).fork()).join();
    }
...
export const Header: MessageFns<Header, "ibc.lightclients.solomachine.v2.Header"> = {
  ...
  encode(message: Header, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.new_public_key !== undefined) {
      Any.encode(message.new_public_key, writer.uint32(34).fork()).join();
    }
...
export const Misbehaviour: MessageFns<Misbehaviour, "ibc.lightclients.solomachine.v2.Misbehaviour"> = {
  ...
  encode(message: Misbehaviour, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.signature_one !== undefined) {
      SignatureAndData.encode(message.signature_one, writer.uint32(26).fork()).join();
    }
    if (message.signature_two !== undefined) {
      SignatureAndData.encode(message.signature_two, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
export const HeaderData: MessageFns<HeaderData, "ibc.lightclients.solomachine.v2.HeaderData"> = {
  ...
  encode(message: HeaderData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.new_pub_key !== undefined) {
      Any.encode(message.new_pub_key, writer.uint32(10).fork()).join();
    }
    if (message.new_diversifier !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.next_seq_recv = reader.uint64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
