...
export const GenesisState: MessageFns<GenesisState, "ibc.applications.interchain_accounts.genesis.v1.GenesisState"> = {
  ...
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.controller_genesis_state !== undefined) {
      ControllerGenesisState.encode(message.controller_genesis_state, writer.uint32(10).fork()).join();
    }
    if (message.host_genesis_state !== undefined) {
      HostGenesisState.encode(message.host_genesis_state, writer.uint32(18).fork()).join();
    }
    return writer;
  },
