...
export const MsgRegisterPayee: MessageFns<MsgRegisterPayee, "ibc.applications.fee.v1.MsgRegisterPayee"> = {
...
export const MsgRegisterPayeeResponse: MessageFns<
...
export const MsgRegisterCounterpartyPayee: MessageFns<
...
export const MsgRegisterCounterpartyPayeeResponse: MessageFns<
...
export const MsgPayPacketFee: MessageFns<MsgPayPacketFee, "ibc.applications.fee.v1.MsgPayPacketFee"> = {
...
export const MsgPayPacketFeeResponse: MessageFns<
...
export const MsgPayPacketFeeAsync: MessageFns<MsgPayPacketFeeAsync, "ibc.applications.fee.v1.MsgPayPacketFeeAsync"> = {
  ...
  encode(message: MsgPayPacketFeeAsync, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.packet_fee !== undefined) {
      PacketFee.encode(message.packet_fee, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const MsgPayPacketFeeAsyncResponse: MessageFns<
