...
export const QueryIncentivizedPacketsRequest: MessageFns<
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.query_height = reader.uint64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const QueryIncentivizedPacketsResponse: MessageFns<
...
export const QueryIncentivizedPacketRequest: MessageFns<
...
> = {
  ...
  encode(message: QueryIncentivizedPacketRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.packet_id !== undefined) {
      PacketId.encode(message.packet_id, writer.uint32(10).fork()).join();
    }
    if (message.query_height !== "0") {
      writer.uint32(16).uint64(message.query_height);
    }
...
export const QueryIncentivizedPacketResponse: MessageFns<
...
> = {
  ...
  encode(message: QueryIncentivizedPacketResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.incentivized_packet !== undefined) {
      IdentifiedPacketFees.encode(message.incentivized_packet, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const QueryIncentivizedPacketsForChannelRequest: MessageFns<
...
export const QueryIncentivizedPacketsForChannelResponse: MessageFns<
...
export const QueryTotalRecvFeesRequest: MessageFns<
...
export const QueryTotalRecvFeesResponse: MessageFns<
...
export const QueryTotalAckFeesRequest: MessageFns<
...
export const QueryTotalAckFeesResponse: MessageFns<
...
export const QueryTotalTimeoutFeesRequest: MessageFns<
...
export const QueryTotalTimeoutFeesResponse: MessageFns<
...
export const QueryPayeeRequest: MessageFns<QueryPayeeRequest, "ibc.applications.fee.v1.QueryPayeeRequest"> = {
...
export const QueryPayeeResponse: MessageFns<QueryPayeeResponse, "ibc.applications.fee.v1.QueryPayeeResponse"> = {
...
export const QueryCounterpartyPayeeRequest: MessageFns<
...
export const QueryCounterpartyPayeeResponse: MessageFns<
...
export const QueryFeeEnabledChannelsRequest: MessageFns<
...
export const QueryFeeEnabledChannelsResponse: MessageFns<
...
export const QueryFeeEnabledChannelRequest: MessageFns<
...
export const QueryFeeEnabledChannelResponse: MessageFns<
