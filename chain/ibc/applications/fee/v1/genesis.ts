...
export const GenesisState: MessageFns<GenesisState, "ibc.applications.fee.v1.GenesisState"> = {
...
export const FeeEnabledChannel: MessageFns<FeeEnabledChannel, "ibc.applications.fee.v1.FeeEnabledChannel"> = {
...
export const RegisteredPayee: MessageFns<RegisteredPayee, "ibc.applications.fee.v1.RegisteredPayee"> = {
...
export const RegisteredCounterpartyPayee: MessageFns<
...
export const ForwardRelayerAddress: MessageFns<ForwardRelayerAddress, "ibc.applications.fee.v1.ForwardRelayerAddress"> =
  {
    ...
    encode(message: ForwardRelayerAddress, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
      ...
      if (message.packet_id !== undefined) {
        PacketId.encode(message.packet_id, writer.uint32(18).fork()).join();
      }
      return writer;
    },
