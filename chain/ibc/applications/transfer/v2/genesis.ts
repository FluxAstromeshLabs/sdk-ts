...
export const GenesisState: MessageFns<GenesisState, "ibc.applications.transfer.v2.GenesisState"> = {
  ...
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.forwarded_packets) {
      ForwardedPacket.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export const ForwardedPacket: MessageFns<ForwardedPacket, "ibc.applications.transfer.v2.ForwardedPacket"> = {
  $type: "ibc.applications.transfer.v2.ForwardedPacket" as const,

  encode(message: ForwardedPacket, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.forward_key !== undefined) {
      PacketId.encode(message.forward_key, writer.uint32(10).fork()).join();
    }
