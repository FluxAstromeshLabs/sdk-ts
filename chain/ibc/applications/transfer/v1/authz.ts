...
export const Allocation: MessageFns<Allocation, "ibc.applications.transfer.v1.Allocation"> = {
  ...
  encode(message: Allocation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.allowed_forwarding) {
      AllowedForwarding.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
export const AllowedForwarding: MessageFns<AllowedForwarding, "ibc.applications.transfer.v1.AllowedForwarding"> = {
  $type: "ibc.applications.transfer.v1.AllowedForwarding" as const,

  encode(message: AllowedForwarding, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.hops) {
      Hop.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
