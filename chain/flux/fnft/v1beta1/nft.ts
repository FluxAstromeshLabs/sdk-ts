...
export const Class: MessageFns<Class, "flux.fnft.v1beta1.Class"> = {
...
export const NFT: MessageFns<NFT, "flux.fnft.v1beta1.NFT"> = {
  ...
  encode(message: NFT, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.initial_price !== undefined) {
      Coin.encode(message.initial_price, writer.uint32(58).fork()).join();
    }
    ...
    for (const v of message.sponsorships) {
      Sponsorship.encode(v!, writer.uint32(90).fork()).join();
    }
    if (message.revenue !== undefined) {
      Coin.encode(message.revenue, writer.uint32(98).fork()).join();
    }
    ...
    if (message.data !== undefined) {
      Any.encode(message.data, writer.uint32(154).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14:
          ...
          message.last_dividend_timestamp = reader.uint64().toString();
          continue;
        case 15:
          if (tag !== 122) {
            break;
        ...
        case 16:
          ...
          message.product_count = reader.uint64().toString();
          continue;
        case 17:
          if (tag !== 136) {
            break;
          ...
          message.holder_count = reader.uint64().toString();
          continue;
        case 18:
          if (tag !== 144) {
            break;
...
export const Sponsorship: MessageFns<Sponsorship, "flux.fnft.v1beta1.Sponsorship"> = {
  $type: "flux.fnft.v1beta1.Sponsorship" as const,

  encode(message: Sponsorship, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Sponsorship {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Holder: MessageFns<Holder, "flux.fnft.v1beta1.Holder"> = {
