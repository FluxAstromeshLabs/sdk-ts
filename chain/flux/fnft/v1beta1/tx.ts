...
export const MsgCreate: MessageFns<MsgCreate, "flux.fnft.v1beta1.MsgCreate"> = {
  $type: "flux.fnft.v1beta1.MsgCreate" as const,

  encode(message: MsgCreate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
    ...
    if (message.initial_price !== undefined) {
      Coin.encode(message.initial_price, writer.uint32(42).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.ISO_timestamp = reader.uint64().toString();
          continue;
        case 7:
          if (tag !== 56) {
            break;
          ...
          message.ISO_success_percent = reader.uint64().toString();
          continue;
        case 8:
          if (tag !== 66) {
            break;
        ...
        case 9:
          ...
          message.dividend_interval = reader.uint64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const MsgCreateResponse: MessageFns<MsgCreateResponse, "flux.fnft.v1beta1.MsgCreateResponse"> = {
...
export const MsgPurchaseShares: MessageFns<MsgPurchaseShares, "flux.fnft.v1beta1.MsgPurchaseShares"> = {
  $type: "flux.fnft.v1beta1.MsgPurchaseShares" as const,

  encode(message: MsgPurchaseShares, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    if (message.class_id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgPurchaseShares {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgPurchaseSharesResponse: MessageFns<
  MsgPurchaseSharesResponse,
  "flux.fnft.v1beta1.MsgPurchaseSharesResponse"
> = {
  $type: "flux.fnft.v1beta1.MsgPurchaseSharesResponse" as const,

  encode(_: MsgPurchaseSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgPurchaseSharesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgTransferShares: MessageFns<MsgTransferShares, "flux.fnft.v1beta1.MsgTransferShares"> = {
  $type: "flux.fnft.v1beta1.MsgTransferShares" as const,

  encode(message: MsgTransferShares, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.class_id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgTransferShares {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgTransferSharesResponse: MessageFns<
  MsgTransferSharesResponse,
  "flux.fnft.v1beta1.MsgTransferSharesResponse"
> = {
  $type: "flux.fnft.v1beta1.MsgTransferSharesResponse" as const,

  encode(_: MsgTransferSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgTransferSharesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDepositShares: MessageFns<MsgDepositShares, "flux.fnft.v1beta1.MsgDepositShares"> = {
  $type: "flux.fnft.v1beta1.MsgDepositShares" as const,

  encode(message: MsgDepositShares, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.class_id !== "") {
      writer.uint32(10).string(message.class_id);
    }
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDepositShares {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDepositSharesResponse: MessageFns<
  MsgDepositSharesResponse,
  "flux.fnft.v1beta1.MsgDepositSharesResponse"
> = {
  $type: "flux.fnft.v1beta1.MsgDepositSharesResponse" as const,

  encode(_: MsgDepositSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgDepositSharesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgWithdrawShares: MessageFns<MsgWithdrawShares, "flux.fnft.v1beta1.MsgWithdrawShares"> = {
  $type: "flux.fnft.v1beta1.MsgWithdrawShares" as const,

  encode(message: MsgWithdrawShares, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.class_id !== "") {
      writer.uint32(10).string(message.class_id);
    }
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgWithdrawShares {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgWithdrawSharesResponse: MessageFns<
  MsgWithdrawSharesResponse,
  "flux.fnft.v1beta1.MsgWithdrawSharesResponse"
> = {
  $type: "flux.fnft.v1beta1.MsgWithdrawSharesResponse" as const,

  encode(_: MsgWithdrawSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgWithdrawSharesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSponsor: MessageFns<MsgSponsor, "flux.fnft.v1beta1.MsgSponsor"> = {
  $type: "flux.fnft.v1beta1.MsgSponsor" as const,

  encode(message: MsgSponsor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    if (message.class_id !== "") {
...
export const MsgSponsorResponse: MessageFns<MsgSponsorResponse, "flux.fnft.v1beta1.MsgSponsorResponse"> = {
  $type: "flux.fnft.v1beta1.MsgSponsorResponse" as const,

  encode(_: MsgSponsorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
