...
export const QueryBalanceRequest: MessageFns<QueryBalanceRequest, "flux.fnft.v1beta1.QueryBalanceRequest"> = {
...
export const QueryBalanceResponse: MessageFns<QueryBalanceResponse, "flux.fnft.v1beta1.QueryBalanceResponse"> = {
...
export const QueryOwnerRequest: MessageFns<QueryOwnerRequest, "flux.fnft.v1beta1.QueryOwnerRequest"> = {
...
export const QueryOwnerResponse: MessageFns<QueryOwnerResponse, "flux.fnft.v1beta1.QueryOwnerResponse"> = {
...
export const QuerySupplyRequest: MessageFns<QuerySupplyRequest, "flux.fnft.v1beta1.QuerySupplyRequest"> = {
...
export const QuerySupplyResponse: MessageFns<QuerySupplyResponse, "flux.fnft.v1beta1.QuerySupplyResponse"> = {
...
export const QueryHolderRequest: MessageFns<QueryHolderRequest, "flux.fnft.v1beta1.QueryHolderRequest"> = {
  $type: "flux.fnft.v1beta1.QueryHolderRequest" as const,

  encode(message: QueryHolderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.class_id !== "") {
      writer.uint32(10).string(message.class_id);
    }
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryHolderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryHolderResponse: MessageFns<QueryHolderResponse, "flux.fnft.v1beta1.QueryHolderResponse"> = {
  $type: "flux.fnft.v1beta1.QueryHolderResponse" as const,

  encode(message: QueryHolderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.holder !== undefined) {
      Holder.encode(message.holder, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryHolderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryHoldersRequest: MessageFns<QueryHoldersRequest, "flux.fnft.v1beta1.QueryHoldersRequest"> = {
...
export const QueryHoldersResponse: MessageFns<QueryHoldersResponse, "flux.fnft.v1beta1.QueryHoldersResponse"> = {
...
export const QueryNFTsRequest: MessageFns<QueryNFTsRequest, "flux.fnft.v1beta1.QueryNFTsRequest"> = {
...
export const QueryNFTsResponse: MessageFns<QueryNFTsResponse, "flux.fnft.v1beta1.QueryNFTsResponse"> = {
...
export const QueryNFTRequest: MessageFns<QueryNFTRequest, "flux.fnft.v1beta1.QueryNFTRequest"> = {
...
export const QueryNFTResponse: MessageFns<QueryNFTResponse, "flux.fnft.v1beta1.QueryNFTResponse"> = {
...
export const QueryClassRequest: MessageFns<QueryClassRequest, "flux.fnft.v1beta1.QueryClassRequest"> = {
...
export const QueryClassResponse: MessageFns<QueryClassResponse, "flux.fnft.v1beta1.QueryClassResponse"> = {
...
export const QueryClassesRequest: MessageFns<QueryClassesRequest, "flux.fnft.v1beta1.QueryClassesRequest"> = {
...
export const QueryClassesResponse: MessageFns<QueryClassesResponse, "flux.fnft.v1beta1.QueryClassesResponse"> = {
