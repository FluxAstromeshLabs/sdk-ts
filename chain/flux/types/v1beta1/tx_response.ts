...
export const TxResponseGenericMessage: MessageFns<
  TxResponseGenericMessage,
  "flux.types.v1beta1.TxResponseGenericMessage"
> = {
...
export const TxResponseData: MessageFns<TxResponseData, "flux.types.v1beta1.TxResponseData"> = {
