...
export const ClassesRequest: MessageFns<ClassesRequest, "flux.indexer.fnft.ClassesRequest"> = {
  $type: "flux.indexer.fnft.ClassesRequest" as const,

  encode(_: ClassesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClassesRequest {
...
export const ClassesResponse: MessageFns<ClassesResponse, "flux.indexer.fnft.ClassesResponse"> = {
  $type: "flux.indexer.fnft.ClassesResponse" as const,

  encode(message: ClassesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
    ...
    for (const v of message.classes) {
      Class.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClassesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const NFTsRequest: MessageFns<NFTsRequest, "flux.indexer.fnft.NFTsRequest"> = {
  $type: "flux.indexer.fnft.NFTsRequest" as const,

  encode(message: NFTsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.class_id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NFTsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const NFTsResponse: MessageFns<NFTsResponse, "flux.indexer.fnft.NFTsResponse"> = {
  $type: "flux.indexer.fnft.NFTsResponse" as const,

  encode(message: NFTsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
      writer.uint32(8).uint64(message.height);
    }
    if (message.deleted !== "0") {
    ...
    for (const v of message.nfts) {
      NFT.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NFTsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const HoldersRequest: MessageFns<HoldersRequest, "flux.indexer.fnft.HoldersRequest"> = {
  $type: "flux.indexer.fnft.HoldersRequest" as const,

  encode(message: HoldersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.class_id !== "") {
      writer.uint32(10).string(message.class_id);
    }
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HoldersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const HoldersResponse: MessageFns<HoldersResponse, "flux.indexer.fnft.HoldersResponse"> = {
  $type: "flux.indexer.fnft.HoldersResponse" as const,

  encode(message: HoldersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
      writer.uint32(8).uint64(message.height);
    }
    if (message.deleted !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HoldersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
