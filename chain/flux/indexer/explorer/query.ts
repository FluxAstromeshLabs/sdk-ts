...
export const ListEvmContractsRequest: MessageFns<
  ListEvmContractsRequest,
  "flux.indexer.explorer.ListEvmContractsRequest"
> = {
  $type: "flux.indexer.explorer.ListEvmContractsRequest" as const,

  encode(message: ListEvmContractsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListEvmContractsRequest {
...
export const ListEvmContractsResponse: MessageFns<
  ListEvmContractsResponse,
  "flux.indexer.explorer.ListEvmContractsResponse"
> = {
  $type: "flux.indexer.explorer.ListEvmContractsResponse" as const,

  encode(message: ListEvmContractsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.contracts) {
      ContractInfo.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListEvmContractsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BalancesRequest: MessageFns<BalancesRequest, "flux.indexer.explorer.BalancesRequest"> = {
  $type: "flux.indexer.explorer.BalancesRequest" as const,

  encode(message: BalancesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BalancesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BalanceInfo: MessageFns<BalanceInfo, "flux.indexer.explorer.BalanceInfo"> = {
  $type: "flux.indexer.explorer.BalanceInfo" as const,

  encode(message: BalanceInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.acc !== "") {
    ...
    if (message.denom_metadata !== undefined) {
      TokenMetadata.encode(message.denom_metadata, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BalanceInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.updated_height = reader.uint64().toString();
          continue;
        case 6:
          if (tag !== 48) {
            break;
          ...
          message.updated_time = reader.uint64().toString();
          continue;
        case 7:
          if (tag !== 58) {
            break;
...
export const BalancesResponse: MessageFns<BalancesResponse, "flux.indexer.explorer.BalancesResponse"> = {
  $type: "flux.indexer.explorer.BalancesResponse" as const,

  encode(message: BalancesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.balances) {
      BalanceInfo.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BalancesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TypeFilter: MessageFns<TypeFilter, "flux.indexer.explorer.TypeFilter"> = {
...
export const SupportedAppFilter: MessageFns<SupportedAppFilter, "flux.indexer.explorer.SupportedAppFilter"> = {
  $type: "flux.indexer.explorer.SupportedAppFilter" as const,

  encode(message: SupportedAppFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.plane !== 0) {
    ...
    if (message.verified !== undefined) {
      BoolValue.encode({ value: message.verified! }, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SupportedAppFilter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListStrategiesRequest: MessageFns<ListStrategiesRequest, "flux.indexer.explorer.ListStrategiesRequest"> = {
  ...
  encode(message: ListStrategiesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.type !== undefined) {
      TypeFilter.encode(message.type, writer.uint32(18).fork()).join();
    }
    if (message.id !== "") {
      writer.uint32(26).string(message.id);
    }
    if (message.enabled !== undefined) {
      BoolValue.encode({ value: message.enabled! }, writer.uint32(34).fork()).join();
    }
    for (const v of message.tags) {
      writer.uint32(42).string(v!);
    }
    if (message.supported_app !== undefined) {
      SupportedAppFilter.encode(message.supported_app, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
export const ListStrategiesResponse: MessageFns<
  ...
  "flux.indexer.explorer.ListStrategiesResponse"
> = {
  ...
  encode(message: ListStrategiesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.strategies) {
      Strategy.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const ListStrategiesByOwnerRequest: MessageFns<
  ...
  "flux.indexer.explorer.ListStrategiesByOwnerRequest"
> = {
  ...
  encode(message: ListStrategiesByOwnerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.type !== undefined) {
      TypeFilter.encode(message.type, writer.uint32(26).fork()).join();
    }
    if (message.enabled !== undefined) {
      BoolValue.encode({ value: message.enabled! }, writer.uint32(34).fork()).join();
    }
...
export const Pool: MessageFns<Pool, "flux.indexer.explorer.Pool"> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.swap_count = reader.int64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const Metrics: MessageFns<Metrics, "flux.indexer.explorer.Metrics"> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.tx_count = reader.int64().toString();
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.block_count = reader.int64().toString();
          continue;
        case 3:
          if (tag !== 26) {
            break;
...
export const GetMetricsRequest: MessageFns<GetMetricsRequest, "flux.indexer.explorer.GetMetricsRequest"> = {
  $type: "flux.indexer.explorer.GetMetricsRequest" as const,

  encode(_: GetMetricsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const GetMetricsResponse: MessageFns<GetMetricsResponse, "flux.indexer.explorer.GetMetricsResponse"> = {
  ...
  encode(message: GetMetricsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data !== undefined) {
      Metrics.encode(message.data, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const StreamBalanceResponse: MessageFns<StreamBalanceResponse, "flux.indexer.explorer.StreamBalanceResponse"> = {
  $type: "flux.indexer.explorer.StreamBalanceResponse" as const,

  encode(message: StreamBalanceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
    ...
    for (const v of message.balances) {
      BalanceInfo.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamBalanceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListStrategyTriggerByIdRequest: MessageFns<
  ListStrategyTriggerByIdRequest,
  "flux.indexer.explorer.ListStrategyTriggerByIdRequest"
> = {
  $type: "flux.indexer.explorer.ListStrategyTriggerByIdRequest" as const,

  encode(message: ListStrategyTriggerByIdRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    if (message.id !== "") {
    ...
    if (message.success !== undefined) {
      BoolValue.encode({ value: message.success! }, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListStrategyTriggerByIdRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.from_time = reader.int64().toString();
          continue;
        case 4:
          if (tag !== 32) {
            break;
          ...
          message.to_time = reader.int64().toString();
          continue;
        case 5:
          if (tag !== 42) {
            break;
...
export const ListStrategyTriggerByIdResponse: MessageFns<
  ListStrategyTriggerByIdResponse,
  "flux.indexer.explorer.ListStrategyTriggerByIdResponse"
> = {
  $type: "flux.indexer.explorer.ListStrategyTriggerByIdResponse" as const,

  encode(message: ListStrategyTriggerByIdResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    for (const v of message.triggers) {
      StrategyTriggerEvent.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListStrategyTriggerByIdResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamStrategyTriggerRequest: MessageFns<
  StreamStrategyTriggerRequest,
  "flux.indexer.explorer.StreamStrategyTriggerRequest"
> = {
  $type: "flux.indexer.explorer.StreamStrategyTriggerRequest" as const,

  encode(message: StreamStrategyTriggerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StreamStrategyTriggerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamStrategyTriggerResponse: MessageFns<
  StreamStrategyTriggerResponse,
  "flux.indexer.explorer.StreamStrategyTriggerResponse"
> = {
  $type: "flux.indexer.explorer.StreamStrategyTriggerResponse" as const,

  encode(message: StreamStrategyTriggerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
      writer.uint32(8).uint64(message.height);
    }
    if (message.deleted !== "0") {
    ...
    for (const v of message.triggers) {
      StrategyTriggerEvent.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamStrategyTriggerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamStrategiesRequest: MessageFns<
  StreamStrategiesRequest,
  "flux.indexer.explorer.StreamStrategiesRequest"
> = {
  $type: "flux.indexer.explorer.StreamStrategiesRequest" as const,

  encode(message: StreamStrategiesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.owner !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StreamStrategiesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamStrategiesResponse: MessageFns<
  StreamStrategiesResponse,
  "flux.indexer.explorer.StreamStrategiesResponse"
> = {
  $type: "flux.indexer.explorer.StreamStrategiesResponse" as const,

  encode(message: StreamStrategiesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
      writer.uint32(8).uint64(message.height);
    }
    if (message.deleted !== "0") {
    ...
    for (const v of message.strategies) {
      Strategy.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamStrategiesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListTokenMetadataRequest: MessageFns<
  ListTokenMetadataRequest,
  "flux.indexer.explorer.ListTokenMetadataRequest"
> = {
  $type: "flux.indexer.explorer.ListTokenMetadataRequest" as const,

  encode(message: ListTokenMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListTokenMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListTokenMetadataResponse: MessageFns<
  ListTokenMetadataResponse,
  "flux.indexer.explorer.ListTokenMetadataResponse"
> = {
  $type: "flux.indexer.explorer.ListTokenMetadataResponse" as const,

  encode(message: ListTokenMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    for (const v of message.metadata) {
      TokenMetadata.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListTokenMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamTokenMetadataRequest: MessageFns<
  StreamTokenMetadataRequest,
  "flux.indexer.explorer.StreamTokenMetadataRequest"
> = {
  $type: "flux.indexer.explorer.StreamTokenMetadataRequest" as const,

  encode(_: StreamTokenMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamTokenMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamTokenMetadataResponse: MessageFns<
  StreamTokenMetadataResponse,
  "flux.indexer.explorer.StreamTokenMetadataResponse"
> = {
  $type: "flux.indexer.explorer.StreamTokenMetadataResponse" as const,

  encode(message: StreamTokenMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
      writer.uint32(8).uint64(message.height);
    }
    if (message.deleted !== "0") {
    ...
    for (const v of message.metadata) {
      TokenMetadata.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamTokenMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSvmAccountLinksRequest: MessageFns<
  ListSvmAccountLinksRequest,
  "flux.indexer.explorer.ListSvmAccountLinksRequest"
> = {
  $type: "flux.indexer.explorer.ListSvmAccountLinksRequest" as const,

  encode(message: ListSvmAccountLinksRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSvmAccountLinksRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSvmAccountLinksResponse: MessageFns<
  ListSvmAccountLinksResponse,
  "flux.indexer.explorer.ListSvmAccountLinksResponse"
> = {
  $type: "flux.indexer.explorer.ListSvmAccountLinksResponse" as const,

  encode(message: ListSvmAccountLinksResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    for (const v of message.account_links) {
      AccountLink.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListSvmAccountLinksResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamSvmAccountLinkRequest: MessageFns<
  StreamSvmAccountLinkRequest,
  "flux.indexer.explorer.StreamSvmAccountLinkRequest"
> = {
  $type: "flux.indexer.explorer.StreamSvmAccountLinkRequest" as const,

  encode(message: StreamSvmAccountLinkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StreamSvmAccountLinkRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StreamSvmAccountLinkResponse: MessageFns<
  StreamSvmAccountLinkResponse,
  "flux.indexer.explorer.StreamSvmAccountLinkResponse"
> = {
  $type: "flux.indexer.explorer.StreamSvmAccountLinkResponse" as const,

  encode(message: StreamSvmAccountLinkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
      writer.uint32(8).uint64(message.height);
    }
    if (message.deleted !== "0") {
    ...
    for (const v of message.account_link) {
      AccountLink.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamSvmAccountLinkResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
