...
export const ProductsRequest: MessageFns<ProductsRequest, "flux.indexer.bazaar.ProductsRequest"> = {
  $type: "flux.indexer.bazaar.ProductsRequest" as const,

  encode(message: ProductsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.class_id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProductsRequest {
...
export const ProductsResponse: MessageFns<ProductsResponse, "flux.indexer.bazaar.ProductsResponse"> = {
  $type: "flux.indexer.bazaar.ProductsResponse" as const,

  encode(message: ProductsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProductsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
