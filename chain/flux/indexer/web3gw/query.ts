...
export const GetMetaDataRequest: MessageFns<GetMetaDataRequest, "flux.indexer.web3gw.GetMetaDataRequest"> = {
...
export const GetMetaDataResponse: MessageFns<GetMetaDataResponse, "flux.indexer.web3gw.GetMetaDataResponse"> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.max_gas_limit = reader.uint64().toString();
          continue;
        case 4:
          if (tag !== 34) {
            break;
...
export const SignProtoRequest: MessageFns<SignProtoRequest, "flux.indexer.web3gw.SignProtoRequest"> = {
  $type: "flux.indexer.web3gw.SignProtoRequest" as const,

  encode(message: SignProtoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SignProtoRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignProtoResponse: MessageFns<SignProtoResponse, "flux.indexer.web3gw.SignProtoResponse"> = {
  $type: "flux.indexer.web3gw.SignProtoResponse" as const,

  encode(message: SignProtoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SignProtoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignJSONRequest: MessageFns<SignJSONRequest, "flux.indexer.web3gw.SignJSONRequest"> = {
  $type: "flux.indexer.web3gw.SignJSONRequest" as const,

  encode(message: SignJSONRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data.length !== 0) {
      writer.uint32(10).bytes(message.data);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SignJSONRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SignJSONResponse: MessageFns<SignJSONResponse, "flux.indexer.web3gw.SignJSONResponse"> = {
  $type: "flux.indexer.web3gw.SignJSONResponse" as const,

  encode(message: SignJSONResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hash.length !== 0) {
      writer.uint32(10).bytes(message.hash);
    }
    if (message.signature.length !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SignJSONResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FaucetSendRequest: MessageFns<FaucetSendRequest, "flux.indexer.web3gw.FaucetSendRequest"> = {
  $type: "flux.indexer.web3gw.FaucetSendRequest" as const,

  encode(message: FaucetSendRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FaucetSendRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FaucetSendResponse: MessageFns<FaucetSendResponse, "flux.indexer.web3gw.FaucetSendResponse"> = {
  $type: "flux.indexer.web3gw.FaucetSendResponse" as const,

  encode(_: FaucetSendResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FaucetSendResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
