...
export const QueryNFTProductsRequest: MessageFns<
  QueryNFTProductsRequest,
  "flux.bazaar.v1beta1.QueryNFTProductsRequest"
> = {
  $type: "flux.bazaar.v1beta1.QueryNFTProductsRequest" as const,

  encode(message: QueryNFTProductsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.class_id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryNFTProductsRequest {
...
export const QueryNFTProductsResponse: MessageFns<
  QueryNFTProductsResponse,
  "flux.bazaar.v1beta1.QueryNFTProductsResponse"
> = {
  $type: "flux.bazaar.v1beta1.QueryNFTProductsResponse" as const,

  encode(message: QueryNFTProductsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryNFTProductsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryNFTProductRequest: MessageFns<QueryNFTProductRequest, "flux.bazaar.v1beta1.QueryNFTProductRequest"> =
  {
    $type: "flux.bazaar.v1beta1.QueryNFTProductRequest" as const,

    encode(message: QueryNFTProductRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
      if (message.class_id !== "") {
        writer.uint32(10).string(message.class_id);
      }
      if (message.id !== "") {
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): QueryNFTProductRequest {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryNFTProductResponse: MessageFns<
  QueryNFTProductResponse,
  "flux.bazaar.v1beta1.QueryNFTProductResponse"
> = {
  $type: "flux.bazaar.v1beta1.QueryNFTProductResponse" as const,

  encode(message: QueryNFTProductResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryNFTProductResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryVerifiersRequest: MessageFns<QueryVerifiersRequest, "flux.bazaar.v1beta1.QueryVerifiersRequest"> = {
  $type: "flux.bazaar.v1beta1.QueryVerifiersRequest" as const,

  encode(_: QueryVerifiersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryVerifiersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryVerifiersResponse: MessageFns<QueryVerifiersResponse, "flux.bazaar.v1beta1.QueryVerifiersResponse"> =
  {
    $type: "flux.bazaar.v1beta1.QueryVerifiersResponse" as const,

    encode(message: QueryVerifiersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): QueryVerifiersResponse {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
