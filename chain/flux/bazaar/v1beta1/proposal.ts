...
export const ClassCommissionsProposal: MessageFns<
  ClassCommissionsProposal,
  "flux.bazaar.v1beta1.ClassCommissionsProposal"
> = {
  $type: "flux.bazaar.v1beta1.ClassCommissionsProposal" as const,

  encode(message: ClassCommissionsProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
    ...
    for (const v of message.class_commissions) {
      ClassCommission.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClassCommissionsProposal {
...
export const VerifiersProposal: MessageFns<VerifiersProposal, "flux.bazaar.v1beta1.VerifiersProposal"> = {
  $type: "flux.bazaar.v1beta1.VerifiersProposal" as const,

  encode(message: VerifiersProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifiersProposal {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
