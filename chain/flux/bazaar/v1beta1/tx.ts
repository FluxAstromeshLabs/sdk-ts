...
export const MsgCreateProduct: MessageFns<MsgCreateProduct, "flux.bazaar.v1beta1.MsgCreateProduct"> = {
  $type: "flux.bazaar.v1beta1.MsgCreateProduct" as const,

  encode(message: MsgCreateProduct, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
    ...
    for (const v of message.offerings) {
      Offering.encode(v!, writer.uint32(34).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCreateProduct {
...
export const MsgCreateProductResponse: MessageFns<
  MsgCreateProductResponse,
  "flux.bazaar.v1beta1.MsgCreateProductResponse"
> = {
  $type: "flux.bazaar.v1beta1.MsgCreateProductResponse" as const,

  encode(_: MsgCreateProductResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgCreateProductResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgPurchaseOffering: MessageFns<MsgPurchaseOffering, "flux.bazaar.v1beta1.MsgPurchaseOffering"> = {
  $type: "flux.bazaar.v1beta1.MsgPurchaseOffering" as const,

  encode(message: MsgPurchaseOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    if (message.class_id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgPurchaseOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          if (tag === 40) {
            message.offering_idx.push(reader.uint64().toString());
        ...
        case 6:
          if (tag === 48) {
            message.offering_quantity.push(reader.uint64().toString());
...
export const MsgPurchaseOfferingResponse: MessageFns<
  MsgPurchaseOfferingResponse,
  "flux.bazaar.v1beta1.MsgPurchaseOfferingResponse"
> = {
  $type: "flux.bazaar.v1beta1.MsgPurchaseOfferingResponse" as const,

  encode(_: MsgPurchaseOfferingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgPurchaseOfferingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgVerifyProduct: MessageFns<MsgVerifyProduct, "flux.bazaar.v1beta1.MsgVerifyProduct"> = {
  $type: "flux.bazaar.v1beta1.MsgVerifyProduct" as const,

  encode(message: MsgVerifyProduct, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    if (message.class_id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgVerifyProduct {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgVerifyProductResponse: MessageFns<
  MsgVerifyProductResponse,
  "flux.bazaar.v1beta1.MsgVerifyProductResponse"
> = {
  $type: "flux.bazaar.v1beta1.MsgVerifyProductResponse" as const,

  encode(_: MsgVerifyProductResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgVerifyProductResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
