...
export const EventsRequest: MessageFns<EventsRequest, "flux.eventstream.v1beta1.EventsRequest"> = {
  $type: "flux.eventstream.v1beta1.EventsRequest" as const,

  encode(message: EventsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventsRequest {
...
export const EventsResponse: MessageFns<EventsResponse, "flux.eventstream.v1beta1.EventsResponse"> = {
  $type: "flux.eventstream.v1beta1.EventsResponse" as const,

  encode(message: EventsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.height !== "0") {
      writer.uint32(8).uint64(message.height);
    }
    if (message.time !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ModuleEvents: MessageFns<ModuleEvents, "flux.eventstream.v1beta1.ModuleEvents"> = {
  $type: "flux.eventstream.v1beta1.ModuleEvents" as const,

  encode(message: ModuleEvents, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.any_events) {
      AnyEvent.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ModuleEvents {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AnyEvent: MessageFns<AnyEvent, "flux.eventstream.v1beta1.AnyEvent"> = {
  $type: "flux.eventstream.v1beta1.AnyEvent" as const,

  encode(message: AnyEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.module !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AnyEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SyncStatus: MessageFns<SyncStatus, "flux.eventstream.v1beta1.SyncStatus"> = {
  $type: "flux.eventstream.v1beta1.SyncStatus" as const,

  encode(message: SyncStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SyncStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.last_block = reader.uint64().toString();
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.last_block_time = reader.int64().toString();
          continue;
        case 3:
          if (tag !== 24) {
            break;
...
export const NewTxsEvent: MessageFns<NewTxsEvent, "flux.eventstream.v1beta1.NewTxsEvent"> = {
  $type: "flux.eventstream.v1beta1.NewTxsEvent" as const,

  encode(message: NewTxsEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.count !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NewTxsEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WasmEvent: MessageFns<WasmEvent, "flux.eventstream.v1beta1.WasmEvent"> = {
  $type: "flux.eventstream.v1beta1.WasmEvent" as const,

  encode(message: WasmEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.attributes) {
      EventAttribute.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WasmEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
