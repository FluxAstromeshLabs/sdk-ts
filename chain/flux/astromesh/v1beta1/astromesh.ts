...
export const LinkInfo: MessageFns<LinkInfo, "flux.astromesh.v1beta1.LinkInfo"> = {
  $type: "flux.astromesh.v1beta1.LinkInfo" as const,

  encode(message: LinkInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LinkInfo {
