...
export function txActionToJSON(object: TxAction): string {
  switch (object) {
    ...
    case TxAction.COSMOS_INVOKE:
      return "COSMOS_INVOKE";
...
export const MsgChargeVmAccount: MessageFns<MsgChargeVmAccount, "flux.astromesh.v1beta1.MsgChargeVmAccount"> = {
  $type: "flux.astromesh.v1beta1.MsgChargeVmAccount" as const,

  encode(message: MsgChargeVmAccount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgChargeVmAccount {
...
export const MsgChargeVmAccountResponse: MessageFns<
  MsgChargeVmAccountResponse,
  "flux.astromesh.v1beta1.MsgChargeVmAccountResponse"
> = {
  $type: "flux.astromesh.v1beta1.MsgChargeVmAccountResponse" as const,

  encode(_: MsgChargeVmAccountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgChargeVmAccountResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDrainVmAccount: MessageFns<MsgDrainVmAccount, "flux.astromesh.v1beta1.MsgDrainVmAccount"> = {
  $type: "flux.astromesh.v1beta1.MsgDrainVmAccount" as const,

  encode(message: MsgDrainVmAccount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    if (message.plane !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDrainVmAccount {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDrainVmAccountResponse: MessageFns<
  MsgDrainVmAccountResponse,
  "flux.astromesh.v1beta1.MsgDrainVmAccountResponse"
> = {
  $type: "flux.astromesh.v1beta1.MsgDrainVmAccountResponse" as const,

  encode(_: MsgDrainVmAccountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgDrainVmAccountResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgAstroTransfer: MessageFns<MsgAstroTransfer, "flux.astromesh.v1beta1.MsgAstroTransfer"> = {
  $type: "flux.astromesh.v1beta1.MsgAstroTransfer" as const,

  encode(message: MsgAstroTransfer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    if (message.receiver !== "") {
    ...
    if (message.coin !== undefined) {
      Coin.encode(message.coin, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgAstroTransfer {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgAstroTransferResponse: MessageFns<
  MsgAstroTransferResponse,
  "flux.astromesh.v1beta1.MsgAstroTransferResponse"
> = {
  $type: "flux.astromesh.v1beta1.MsgAstroTransferResponse" as const,

  encode(message: MsgAstroTransferResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgAstroTransferResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FISInstruction: MessageFns<FISInstruction, "flux.astromesh.v1beta1.FISInstruction"> = {
  $type: "flux.astromesh.v1beta1.FISInstruction" as const,

  encode(message: FISInstruction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.plane !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FISInstruction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FISInstructionResponse: MessageFns<
  FISInstructionResponse,
  "flux.astromesh.v1beta1.FISInstructionResponse"
> = {
  $type: "flux.astromesh.v1beta1.FISInstructionResponse" as const,

  encode(message: FISInstructionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.plane !== 0) {
      writer.uint32(8).int32(message.plane);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FISInstructionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgFISTransaction: MessageFns<MsgFISTransaction, "flux.astromesh.v1beta1.MsgFISTransaction"> = {
  $type: "flux.astromesh.v1beta1.MsgFISTransaction" as const,

  encode(message: MsgFISTransaction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    for (const v of message.instructions) {
      FISInstruction.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgFISTransaction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgFISTransactionResponse: MessageFns<
  MsgFISTransactionResponse,
  "flux.astromesh.v1beta1.MsgFISTransactionResponse"
> = {
  $type: "flux.astromesh.v1beta1.MsgFISTransactionResponse" as const,

  encode(message: MsgFISTransactionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.instruction_responses) {
      FISInstructionResponse.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgFISTransactionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
