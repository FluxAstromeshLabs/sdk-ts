...
export const AccountBalance: MessageFns<AccountBalance, "flux.astromesh.v1beta1.AccountBalance"> = {
...
export const DenomBalanceUpdate: MessageFns<DenomBalanceUpdate, "flux.astromesh.v1beta1.DenomBalanceUpdate"> = {
  $type: "flux.astromesh.v1beta1.DenomBalanceUpdate" as const,

  encode(message: DenomBalanceUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.denom !== "") {
      writer.uint32(10).string(message.denom);
    }
    for (const v of message.balances) {
      AccountBalance.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DenomBalanceUpdate {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BalanceUpdateEvent: MessageFns<BalanceUpdateEvent, "flux.astromesh.v1beta1.BalanceUpdateEvent"> = {
  $type: "flux.astromesh.v1beta1.BalanceUpdateEvent" as const,

  encode(message: BalanceUpdateEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.op !== 0) {
      writer.uint32(8).int32(message.op);
    }
    for (const v of message.upd) {
      DenomBalanceUpdate.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.plane !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BalanceUpdateEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TokenMetadata: MessageFns<TokenMetadata, "flux.astromesh.v1beta1.TokenMetadata"> = {
...
export const TokenMetadataEvent: MessageFns<TokenMetadataEvent, "flux.astromesh.v1beta1.TokenMetadataEvent"> = {
  $type: "flux.astromesh.v1beta1.TokenMetadataEvent" as const,

  encode(message: TokenMetadataEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.op !== 0) {
      writer.uint32(8).int32(message.op);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TokenMetadataEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
