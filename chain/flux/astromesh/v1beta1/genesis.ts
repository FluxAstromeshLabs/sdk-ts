...
export const GenesisState: MessageFns<GenesisState, "flux.astromesh.v1beta1.GenesisState"> = {
  $type: "flux.astromesh.v1beta1.GenesisState" as const,

  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.denom_links) {
      DenomLink.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const DenomLink: MessageFns<DenomLink, "flux.astromesh.v1beta1.DenomLink"> = {
  $type: "flux.astromesh.v1beta1.DenomLink" as const,

  encode(message: DenomLink, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DenomLink {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
