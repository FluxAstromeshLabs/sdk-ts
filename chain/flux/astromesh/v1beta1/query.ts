...
export function queryActionFromJSON(object: any): QueryAction {
  switch (object) {
    ...
    case 5:
    case "COSMOS_KVSTORE":
      return QueryAction.COSMOS_KVSTORE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function queryActionToJSON(object: QueryAction): string {
  switch (object) {
    ...
    case QueryAction.COSMOS_EVENT:
      return "COSMOS_EVENT";
    case QueryAction.COSMOS_KVSTORE:
      return "COSMOS_KVSTORE";
...
export const QueryDenomLinkRequest: MessageFns<QueryDenomLinkRequest, "flux.astromesh.v1beta1.QueryDenomLinkRequest"> =
  {
    $type: "flux.astromesh.v1beta1.QueryDenomLinkRequest" as const,

    encode(message: QueryDenomLinkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): QueryDenomLinkRequest {
...
export const QueryDenomLinkResponse: MessageFns<
  QueryDenomLinkResponse,
  "flux.astromesh.v1beta1.QueryDenomLinkResponse"
> = {
  $type: "flux.astromesh.v1beta1.QueryDenomLinkResponse" as const,

  encode(message: QueryDenomLinkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dst_addr !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryDenomLinkResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BalanceRequest: MessageFns<BalanceRequest, "flux.astromesh.v1beta1.BalanceRequest"> = {
...
export const BalanceResponse: MessageFns<BalanceResponse, "flux.astromesh.v1beta1.BalanceResponse"> = {
...
export const FISQueryInstruction: MessageFns<FISQueryInstruction, "flux.astromesh.v1beta1.FISQueryInstruction"> = {
  $type: "flux.astromesh.v1beta1.FISQueryInstruction" as const,

  encode(message: FISQueryInstruction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.plane !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FISQueryInstruction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FISQueryInstructionResponse: MessageFns<
  FISQueryInstructionResponse,
  "flux.astromesh.v1beta1.FISQueryInstructionResponse"
> = {
  $type: "flux.astromesh.v1beta1.FISQueryInstructionResponse" as const,

  encode(message: FISQueryInstructionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.plane !== 0) {
      writer.uint32(8).int32(message.plane);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FISQueryInstructionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FISQueryRequest: MessageFns<FISQueryRequest, "flux.astromesh.v1beta1.FISQueryRequest"> = {
  $type: "flux.astromesh.v1beta1.FISQueryRequest" as const,

  encode(message: FISQueryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.instructions) {
      FISQueryInstruction.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FISQueryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FISQueryResponse: MessageFns<FISQueryResponse, "flux.astromesh.v1beta1.FISQueryResponse"> = {
  $type: "flux.astromesh.v1beta1.FISQueryResponse" as const,

  encode(message: FISQueryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.instruction_responses) {
      FISQueryInstructionResponse.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FISQueryResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
