...
export const MsgPushSimpleEntry: MessageFns<MsgPushSimpleEntry, "flux.oracle.v1beta1.MsgPushSimpleEntry"> = {
  $type: "flux.oracle.v1beta1.MsgPushSimpleEntry" as const,

  encode(message: MsgPushSimpleEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    for (const v of message.entries) {
      SimpleEntry.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgPushSimpleEntry {
...
export const MsgPushSimpleEntryResponse: MessageFns<
  MsgPushSimpleEntryResponse,
  "flux.oracle.v1beta1.MsgPushSimpleEntryResponse"
> = {
  $type: "flux.oracle.v1beta1.MsgPushSimpleEntryResponse" as const,

  encode(_: MsgPushSimpleEntryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgPushSimpleEntryResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
