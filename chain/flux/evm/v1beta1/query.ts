...
export const BalanceRequest: MessageFns<BalanceRequest, "flux.evm.v1beta1.BalanceRequest"> = {
...
export const BalanceResponse: MessageFns<BalanceResponse, "flux.evm.v1beta1.BalanceResponse"> = {
  $type: "flux.evm.v1beta1.BalanceResponse" as const,

  encode(_: BalanceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const ContractQueryRequest: MessageFns<ContractQueryRequest, "flux.evm.v1beta1.ContractQueryRequest"> = {
  $type: "flux.evm.v1beta1.ContractQueryRequest" as const,

  encode(message: ContractQueryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ContractQueryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ContractQueryResponse: MessageFns<ContractQueryResponse, "flux.evm.v1beta1.ContractQueryResponse"> = {
  $type: "flux.evm.v1beta1.ContractQueryResponse" as const,

  encode(message: ContractQueryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ContractQueryResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
