...
export const MsgDeployContract: MessageFns<MsgDeployContract, "flux.evm.v1beta1.MsgDeployContract"> = {
  $type: "flux.evm.v1beta1.MsgDeployContract" as const,

  encode(message: MsgDeployContract, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeployContract {
...
export const MsgDeployContractResponse: MessageFns<
  MsgDeployContractResponse,
  "flux.evm.v1beta1.MsgDeployContractResponse"
> = {
  $type: "flux.evm.v1beta1.MsgDeployContractResponse" as const,

  encode(message: MsgDeployContractResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDeployContractResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgExecuteContract: MessageFns<MsgExecuteContract, "flux.evm.v1beta1.MsgExecuteContract"> = {
...
export const MsgExecuteContractResponse: MessageFns<
  ...
  "flux.evm.v1beta1.MsgExecuteContractResponse"
> = {
