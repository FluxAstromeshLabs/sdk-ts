...
export const AccountLink: MessageFns<AccountLink, "flux.svm.v1beta1.AccountLink"> = {
...
export const Account: MessageFns<Account, "flux.svm.v1beta1.Account"> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.rent_epoch = reader.uint64().toString();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const InstructionAccount: MessageFns<InstructionAccount, "flux.svm.v1beta1.InstructionAccount"> = {
  $type: "flux.svm.v1beta1.InstructionAccount" as const,

  encode(message: InstructionAccount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InstructionAccount {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Instruction: MessageFns<Instruction, "flux.svm.v1beta1.Instruction"> = {
  ...
  encode(message: Instruction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.accounts) {
      InstructionAccount.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.data.length !== 0) {
