...
export const PermissionConfig: MessageFns<PermissionConfig, "flux.strategy.v1beta1.PermissionConfig"> = {
  $type: "flux.strategy.v1beta1.PermissionConfig" as const,

  encode(message: PermissionConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PermissionConfig {
...
export const Strategy: MessageFns<Strategy, "flux.strategy.v1beta1.Strategy"> = {
  ...
  encode(message: Strategy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.query !== undefined) {
      FISQueryRequest.encode(message.query, writer.uint32(34).fork()).join();
    }
    if (message.is_enabled !== false) {
      writer.uint32(40).bool(message.is_enabled);
    }
    if (message.trigger_permission !== undefined) {
      PermissionConfig.encode(message.trigger_permission, writer.uint32(50).fork()).join();
    }
...
export const SchemaFISInstruction: MessageFns<SchemaFISInstruction, "flux.strategy.v1beta1.SchemaFISInstruction"> = {
  $type: "flux.strategy.v1beta1.SchemaFISInstruction" as const,

  encode(message: SchemaFISInstruction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.plane !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SchemaFISInstruction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchemaFISQuery: MessageFns<SchemaFISQuery, "flux.strategy.v1beta1.SchemaFISQuery"> = {
  $type: "flux.strategy.v1beta1.SchemaFISQuery" as const,

  encode(message: SchemaFISQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.instructions) {
      SchemaFISInstruction.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SchemaFISQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchemaPrompt: MessageFns<SchemaPrompt, "flux.strategy.v1beta1.SchemaPrompt"> = {
  $type: "flux.strategy.v1beta1.SchemaPrompt" as const,

  encode(message: SchemaPrompt, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.template !== "") {
      writer.uint32(10).string(message.template);
    }
    if (message.query !== undefined) {
      SchemaFISQuery.encode(message.query, writer.uint32(18).fork()).join();
    }
    Object.entries(message.extensions).forEach(([key, value]) => {
      SchemaPrompt_ExtensionsEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SchemaPrompt {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchemaPrompt_ExtensionsEntry: MessageFns<
  SchemaPrompt_ExtensionsEntry,
  "flux.strategy.v1beta1.SchemaPrompt.ExtensionsEntry"
> = {
  $type: "flux.strategy.v1beta1.SchemaPrompt.ExtensionsEntry" as const,

  encode(message: SchemaPrompt_ExtensionsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SchemaPrompt_ExtensionsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchemaGroup: MessageFns<SchemaGroup, "flux.strategy.v1beta1.SchemaGroup"> = {
  $type: "flux.strategy.v1beta1.SchemaGroup" as const,

  encode(message: SchemaGroup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    Object.entries(message.prompts).forEach(([key, value]) => {
      SchemaGroup_PromptsEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SchemaGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SchemaGroup_PromptsEntry: MessageFns<
  SchemaGroup_PromptsEntry,
  "flux.strategy.v1beta1.SchemaGroup.PromptsEntry"
> = {
  $type: "flux.strategy.v1beta1.SchemaGroup.PromptsEntry" as const,

  encode(message: SchemaGroup_PromptsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      SchemaPrompt.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SchemaGroup_PromptsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StrategyMetadata: MessageFns<StrategyMetadata, "flux.strategy.v1beta1.StrategyMetadata"> = {
  $type: "flux.strategy.v1beta1.StrategyMetadata" as const,

  encode(message: StrategyMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    ...
    for (const v of message.supported_apps) {
      SupportedApp.encode(v!, writer.uint32(98).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StrategyMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.cron_interval = reader.uint64().toString();
          continue;
        case 12:
          if (tag !== 98) {
            break;
...
export const StrategyInput: MessageFns<StrategyInput, "flux.strategy.v1beta1.StrategyInput"> = {
  $type: "flux.strategy.v1beta1.StrategyInput" as const,

  encode(message: StrategyInput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.msg.length !== 0) {
      writer.uint32(10).bytes(message.msg);
    }
    for (const v of message.fis_input) {
      FISInput.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StrategyInput {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FISInput: MessageFns<FISInput, "flux.strategy.v1beta1.FISInput"> = {
  $type: "flux.strategy.v1beta1.FISInput" as const,

  encode(message: FISInput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FISInput {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const StrategyOutput: MessageFns<StrategyOutput, "flux.strategy.v1beta1.StrategyOutput"> = {
  $type: "flux.strategy.v1beta1.StrategyOutput" as const,

  encode(message: StrategyOutput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.instructions) {
      FISInstruction.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StrategyOutput {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SupportedApp: MessageFns<SupportedApp, "flux.strategy.v1beta1.SupportedApp"> = {
  $type: "flux.strategy.v1beta1.SupportedApp" as const,

  encode(message: SupportedApp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SupportedApp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
