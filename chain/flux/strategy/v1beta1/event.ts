...
export const StrategyUpdateEvent = {
  $type: "flux.strategy.v1beta1.StrategyUpdateEvent" as const,

  encode(message: StrategyUpdateEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.op !== 0) {
    ...
    if (message.is_enabled !== undefined) {
      BoolValue.encode({ value: message.is_enabled! }, writer.uint32(26).fork()).ldelim();
    }
    if (message.trigger_permission !== undefined) {
      PermissionConfig.encode(message.trigger_permission, writer.uint32(34).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StrategyUpdateEvent {
...
export const StrategyTriggerEvent = {
  $type: "flux.strategy.v1beta1.StrategyTriggerEvent" as const,

  encode(message: StrategyTriggerEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.op !== 0) {
      writer.uint32(8).int32(message.op);
    }
    if (message.id.length !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): StrategyTriggerEvent {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.gas_consumed = longToString(reader.uint64() as Long);
          continue;
        case 8:
          if (tag !== 66) {
            break;
