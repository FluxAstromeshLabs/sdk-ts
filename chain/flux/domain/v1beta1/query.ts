...
export const QueryDomainInfoRequest: MessageFns<QueryDomainInfoRequest, "flux.domain.v1beta1.QueryDomainInfoRequest"> =
  {
    $type: "flux.domain.v1beta1.QueryDomainInfoRequest" as const,

    encode(message: QueryDomainInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
      if (message.domain !== "") {
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): QueryDomainInfoRequest {
...
export const QueryDomainInfoResponse: MessageFns<
  QueryDomainInfoResponse,
  "flux.domain.v1beta1.QueryDomainInfoResponse"
> = {
  $type: "flux.domain.v1beta1.QueryDomainInfoResponse" as const,

  encode(message: QueryDomainInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.domain !== "") {
      writer.uint32(10).string(message.domain);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryDomainInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryOwnerDomains: MessageFns<QueryOwnerDomains, "flux.domain.v1beta1.QueryOwnerDomains"> = {
  $type: "flux.domain.v1beta1.QueryOwnerDomains" as const,

  encode(message: QueryOwnerDomains, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryOwnerDomains {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryOwnerDomainsResponse: MessageFns<
  QueryOwnerDomainsResponse,
  "flux.domain.v1beta1.QueryOwnerDomainsResponse"
> = {
  $type: "flux.domain.v1beta1.QueryOwnerDomainsResponse" as const,

  encode(message: QueryOwnerDomainsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryOwnerDomainsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryDomainOwner: MessageFns<QueryDomainOwner, "flux.domain.v1beta1.QueryDomainOwner"> = {
  $type: "flux.domain.v1beta1.QueryDomainOwner" as const,

  encode(message: QueryDomainOwner, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.domain !== "") {
      writer.uint32(10).string(message.domain);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryDomainOwner {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryDomainOwnerResponse: MessageFns<
  QueryDomainOwnerResponse,
  "flux.domain.v1beta1.QueryDomainOwnerResponse"
> = {
  $type: "flux.domain.v1beta1.QueryDomainOwnerResponse" as const,

  encode(message: QueryDomainOwnerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.domain !== "") {
      writer.uint32(10).string(message.domain);
    }
    if (message.owner !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryDomainOwnerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
